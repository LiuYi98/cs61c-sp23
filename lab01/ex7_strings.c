...
int main() {
  ...
  char* hello_str = (char*) malloc(sizeof(char) * (strlen("hello") + 1));
  ...
  *(hello_str + 5) = '\0';
  ...
  char* world_str = (char*) malloc(sizeof(char) * (strlen("world") + 1));
  ...
  char* hello_world_str = (char*) malloc(sizeof(char) * (strlen("hello world") + 1));
